...
describe("Formats date time to human readable string using the format string and format specified", () => {
  test("should return Monday, 9th of September, 2019 18:45:12", () => {
    expect(format(new Date("2019 09 09 18:45:12"), "dddd, Do of MMMM, YYYY HH:mm:ss")).toBe(
    ...
    expect(
      format(new Date("2019 09 09 18:45:12"), "Today is dddd, Do of MMMM, YYYY HH:mm:ss"),
