...
test("should return an object with date relating to the end of day", () => {
	const x = {
		...
		minutes: 36,
		seconds: 40,
		totalMilliseconds: 20200000,
		totalWeeks: 0,
		totalHours: 5,
		totalMinutes: 336,
		totalSeconds: 20200
	};
	expect(endOfDayHandler(new Date("2019 08 20 18:23:19"))).toStrictEqual(x);
});
test("should return an object with date relating to the end of hour", () => {
	const x = {
		totalMilliseconds: 2845000,
	...
	expect(endOfHourHandler(new Date("2019 08 20 13:12:34"))).toStrictEqual(x);
});
...
test("explicit test for end of week", () => {
	...
	expect(endOfWeekHandler(new Date("2019 08 24 12:34:09"))).toStrictEqual(x);
});
...
test("explicit test for end of month", () => {
	...
	expect(endOfMonthHandler(new Date("2019 08 29 12:34:09"))).toStrictEqual(x);
...
test("explicit test for end of year", () => {
	...
	expect(endOfYearHandler(new Date("2019 12 29 12:34:09"))).toStrictEqual(x);
...
test("explicit test for end of quarter", () => {
	...
	expect(endOfQuarterHandler(new Date("2019 12 29 12:34:09"))).toStrictEqual(
		x
	);
...
test("explicit test for end of day", () => {
	...
	expect(endOfDayHandler(new Date("2019 12 29 12:34:09"))).toStrictEqual(x);
