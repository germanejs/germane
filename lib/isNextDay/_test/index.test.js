const isNextDay = require("../index");
const germane = require("../../germane");

describe("isNextDay, checks if second is next after first", () => {
  test("should return true", () => {
    expect(isNextDay(new Date("2018-12-31"), new Date("2019-01-01"))).toBe(true);
    expect(isNextDay(new Date("0999-01-01"), new Date("0999-01-02 09:12:12Z"))).toBe(true);
    expect(isNextDay(germane("1970-01-01"), germane("1970-01-02"))).toBe(true);
    expect(isNextDay(germane("2016-09-15T20:18:00Z"), germane("2016-09-16"))).toBe(true);
  ...
  test("should return false", () => {
    ...
    expect(isNextDay(germane("2018-12-30"), germane("2018-12-30"))).toBe(false);
