...
const { endOfMonthHandler } = require("../_util/evaluations/endOf");
 ...
 * @summary returns the end of month for current date, shifting it to UTC time.
 *
 ...
 * ```js
 * endOfMonth(new Date("2109-09-11 11:09:11Z"));
