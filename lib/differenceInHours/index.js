 ...
 * @returns {Number} difference between dates in hours.
 */
function differenceInHours(
	dateOne,
	dateTwo,
	options = { includeTime: false, roundingMethod: "absfloor" }
) {
	...
	const totalHours = useRoundingMethod(
		((timestamp / (3600 * 1000)) * 24) / 24
	);
