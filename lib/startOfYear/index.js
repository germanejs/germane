 ...
 * @fileoverview Handles return of distance between date provided and its startDate of year.
 */

"use strict";

const { startOfYearHandler } = require("../utils/evaluations/startOfDateHandlers");
...
function startOfYear(date) {
  ...
  const handler = startOfYearHandler(typeof date === "number" ? new Date(date) : date);
