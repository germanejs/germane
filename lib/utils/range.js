 ...
 * @description These function takes 3 arguments (start, end, step) and returns the total step it takes from the start to the ending number, putting in consideration the step.
