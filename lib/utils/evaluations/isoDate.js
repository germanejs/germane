...
const ordinalOfPrevYear = require("../evaluations/ordinal_of_prev_year");
const epoch = require("../evaluations/epoch");
const isLeapYear = require("../validations/isLeapYear");
const dayOfWeek = require("../evaluations/dayOfWeek");
 ...
 * @private
 * @description Gets distance from 1st to the day in which the ISO year starts
 */
 ...
 * @param {Number} year Year
 * @private
 * @description Gets distance from 31st December to the day in which the ISO year ends
 */
 ...
 *
 * @param {Number} year Year
 * @description Returns the total ISO days in a given year.
 */
 ...
 * @description 2019-08-11T23:11:09.999Z or 2019-09-09 23:11:11+0900,
