...
function addOrSubMonths(
  ...
  const startEpoch = epoch(...Object.values(startDate));
  ...
  if (type === "sub") {
    ...
    end = epoch(year, month, checkDay, startDate.hour, startDate.minute, startDate.second);
  } else if (type === "add") {
    month = Math.abs(
