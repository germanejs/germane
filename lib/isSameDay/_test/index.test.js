...
describe("isSameDay, checks if given dates are the same", () => {
  test("should return true", () => {
    ...
    expect(isSameDay(germane("1000-01-01", "UTC"), germane("1000-01-01 09:12:12Z", "UTC"))).toBe(
      true,
    );

    expect(isSameDay(new Date("2016-09-15T20:18:00Z"), new Date("2016-09-15 00:00"))).toBe(true);
  });

  test("should return false", () => {
    expect(isSameDay(germane("2019-06-11"), germane("2020-09-12"))).toBe(false);
    expect(isSameDay(germane("2019-06-11 19:00:12"), germane("2019-06-12 02:11"))).toBe(false);
