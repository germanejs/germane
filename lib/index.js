...
const sameDate = require("./_util/evaluations/sameDate");
...
console.log(
  strftime(endOfWeek(germane("2019-10-31 23:11Z", "Asia/Seoul"), { weekStartsOn: 0 }), "%x %X", {
    locale: us,
  }),
);
console.log(
...
console.log(relativeDistance(new Date(), new Date(), { locale: fr, addSuffix: true }));
