...
const isPast = require("./isPast");
const isFuture = require("./isFuture");
const isDate = require("./isDate");
const isValid = require("./isValid");
const add = require("./add");
const sub = require("./subtract");
const epoch = require("./utils/evaluations/epoch");
const germane = require("./germane");
const formatRelative = require("./formatRelative");
// // console.log(useCFormat(germane(Date.now(), "Europe/London"), "%A, %B %do, %Y  %I:%M:%S %p (%c)"));
// console.log(
//   format(new Date("2019-10-27 19:00:00Z"), "Today is dddd, Do of MMMM YYYY, hh:mm:ss A W"),
// );

// const gwd = getBusinessDays(germane("2019-09-19").getTime(), new Date("2019-10-11").getTime()).map(
//   a => useCFormat(germane(a, "Europe/London"), "%do of %B"),
// );
...
// console.log(isSameWeek(germane("2019-12-31"), new Date("2019-12-29")));
...
// console.log(endOfMonth(new Date("2019-09-09 12:34:12Z")));
// console.log(endOfToday());
// console.log(endOfYear(new Date("2019-08-20")));
// console.log(startOfDay(new Date("1800-09-04 23:12:19Z")));
// console.log(startOfHour(Date.now()));
// console.log(startOfMinute(Date.now()));
// console.log(startOfWeek(new Date("2019 09 28 17:09:12")));
// console.log(startOfMonth(germane("2019-08-10")));
// console.log(startOfQuarter(germane("1900-04-01T00:59:49Z")));
...
// console.log(
//   differenceInWords(germane("2020-07-31 19:23:18Z"), germane("2020-12-02 20:45:11Z", "Asia/Seoul")),
// );
// console.log(differenceInWords(new Date("2020-07-31"), germane("2021-12-02", "UTC")));
// console.log(
...
// console.log(format(germane(Date.now()), "Today is dddd, Do of MMMM YYYY, HH:mm:ss in timezone z"));
...
// console.log(formatRelative(germane(), germane("2019W346")));
console.log(formatRelative(new Date("2019 11 11 11:11:01"), new Date("2019 11 12 23:59:59")));

// console.log(germane("2019-123").toString());
// console.log(germane("2019-W01-1").toString());
// console.log(germane("2019-W01").toString());
// console.log(germane("2022-01").toString());

// console.log(
//   germane("2001-09-11T23:51:01.11000Z", "Africa/Cairo").toString(),
//   new Date(germane("2001-09-11T23:51:01.11000Z", "Africa/Cairo")).getDate(),
// );
