...
// console.log(
//   strftime(endOfWeek(germane("2019-10-31 23:11Z", "Asia/Seoul")), "%x %X", { locale: pt }),
// );
// console.log(
//   format(germane(new Date("2019-11-06 13:11")), "locale: {eeee, e},  originale: {EEEE, c}", {
//     locale: de,
//   }),
// );
console.log(relativeDistance(new Date(), new Date("1890-10-15"), { locale: lv, addSuffix: true }));
...
//   ),
// );
console.log(germane("1934W195", "Africa/Lagos", { locale: yo }).toString())
console.log(
