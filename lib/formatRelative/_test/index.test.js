...
describe("formatRelative formats a date time relative to the base date", () => {
  ...
  test("should return today at 5:45 AM", () => {
    expect(formatRelative(new Date("2014-08-20 12:11"), new Date("2014-08-20 05:45:00"))).toBe(
      "Today at 5:45 AM",
    );
  });
  // Yesterday
  test("should return yesterday at 23:22 PM", () => {
    expect(formatRelative(new Date("2014-08-20 12:11"), new Date("2014-08-19 23:22:00"))).toBe(
