const getBusinessDays = require("../index");
...
describe("getBussinessDays, returns array of business days (mon-fri) ranging from first date to second date", () => {
  test("should return an array of  timestamp", () => {
    ...
    //   new Date("2019-09-05").getTime() + 1 * 86400000,
    //   new Date("2019-09-05").getTime() + 2 * 86400000,
    //   new Date("2019-09-05").getTime() + 3 * 86400000,
    //   new Date("2019-09-05").getTime() + 4 * 86400000,
    //   new Date("2019-09-05").getTime() + 5 * 86400000,
    //   new Date("2019-09-05").getTime() + 6 * 86400000,
    //   new Date("2019-09-05").getTime() + 7 * 86400000,
    //   new Date("2019-09-05").getTime() + 8 * 86400000,
    //   new Date("2019-09-05").getTime() + 9 * 86400000,
    //   new Date("2019-09-05").getTime() + 10 * 86400000,
