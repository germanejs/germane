...
describe("Should return difference between a one year range", () => {
	...
	test("should return 2 week, 5 day", () => {
		expect(
			difference(new Date("2019-10-04"), new Date("2019-10-09"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 0,
			week: 0,
	...
	test("should return 2 week, 5 day", () => {
		expect(
			difference(new Date("2019-02-04"), new Date("2019-02-23"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 0,
			week: 2,
	...
	test("should return 3 week, 4 day", () => {
		expect(
			difference(new Date("2019-02-04"), new Date("2019-01-10"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 0,
			week: 3,
	...
	test("should return 1 month, 4 day", () => {
		expect(
			difference(new Date("2019-02-04 23:58Z"), new Date("2019-03-08"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 1,
			week: 0,
	...
	test("should return 1 month, 4 day", () => {
		expect(
			difference(new Date("2019-03-08 11:09:11Z"), new Date("2019-02-04"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 1,
			week: 0,
	...
	test("should return 4 month, 3 week, 5 day", () => {
		expect(
			difference(new Date("2019-02-04"), new Date("2019-06-30"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 4,
			week: 3,
	...
	test("should return 0 month, 0 week, 0 day", () => {
		expect(
			difference(new Date("2019-02-04"), new Date("2019-02-04"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 0,
			week: 0,
	...
	test("should return 9 month", () => {
		expect(
			difference(new Date("2019-02-04"), new Date("2019-11-04"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 9,
			week: 0,
	...
	test("should return 1 month", () => {
		expect(
			difference(new Date("2019-02-04"), new Date("2019-03-04"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 1,
			week: 0,
	...
	test("should return 1 month", () => {
		expect(
			difference(new Date("2019-02-28"), new Date("2019-01-28"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 1,
			week: 0,
	...
	test("should return 1 month", () => {
		expect(
			difference(new Date("2019-02-28"), new Date("2019-01-29"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 1,
			week: 0,
	...
	test("should return 1 month", () => {
		expect(
			difference(new Date("2019-02-28"), new Date("2019-01-30"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 1,
			week: 0,
	...
	test("should return 1 month", () => {
		expect(
			difference(new Date("2019-02-28"), new Date("2019-01-31"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 1,
			week: 0,
	...
	test("should return 1 month, 2 day", () => {
		expect(
			difference(new Date("2019-02-17"), new Date("2019-01-15"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 1,
			week: 0,
	...
	test("should return 1 week 5 day", () => {
		expect(
			difference(new Date("2019-02-16"), new Date("2019-02-28"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 0,
			week: 1,
	...
	test("should return 6 month", () => {
		expect(
			difference(new Date("2019-08-28"), new Date("2019-02-28"), { strict: true })
		).toStrictEqual({
			year: 0,
			month: 6,
			week: 0,
