...
test("explicit test for end of decade", () => {
  expect(
    endOfDecadeHandler(germane("2019-12-29 12:34:09Z", "Africa/Cairo")).toISOString(),
...
test("explicit test for end of decade", () => {
  expect(
    endOfDecadeHandler(germane("2006-10-01 00:34:01Z", "Africa/Lagos")).toISOString(),
  ).toEqual("2009-12-31T22:59:59.999Z");
});
