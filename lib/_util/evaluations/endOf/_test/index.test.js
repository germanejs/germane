...
// +02:00
test("explicit test for end of decade", () => {
  expect(
    endOfDecadeHandler(germane("2019-12-29 12:34:09Z", "Africa/Windhoek")).toISOString(),
  ).toEqual("2019-12-31T21:59:59.999Z");
});

// +01:00
test("explicit test for end of decade", () => {
  expect(
    endOfDecadeHandler(germane("2006-10-01 00:34:091Z", "Africa/Lagos")).toISOString(),
  ).toEqual("2006-12-31T22:59:59.999Z");
});
