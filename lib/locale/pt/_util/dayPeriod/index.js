...
function dayPeriod(hour, min, sec, ms) {
  ...
  // 12:00:00.001 - 18:59:59.999 afternoon

  const afternoonDurationStart = (12 * 3600 + 0 * 60 + 0) * 1000 + 1;
  const afternoonDurationEnd = (18 * 3600 + 59 * 60 + 59) * 1000 + 999;

  const afternoon = inRangeOf(timeToms, afternoonDurationStart, afternoonDurationEnd);

  // in spanish both afternoon and evening are called 'tarde'
  // 19:00:00 - 23:59:59.999 evening

  const eveningDurationStart = (19 * 3600 + 0 * 60 + 0) * 1000;
