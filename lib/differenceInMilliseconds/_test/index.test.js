...
describe("differenceInMilliseconds returns the distance between two dates in milliseconds", () => {
  test("should return the distance in milliseconds", () => {
    ...
    expect(
      differenceInMilliseconds(new Date("2019-12-31 18:34:52Z"), new Date("1970-01-01 12:11:09Z")),
    ).toBe(-1577773423000);
    expect(
      differenceInMilliseconds(new Date("1970-01-01 12:11:09Z"), new Date("2019-12-31 18:34:52Z")),
    ).toBe(1577773423000);
  });
