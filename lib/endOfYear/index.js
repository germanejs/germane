...
const { endOfYearHandler } = require("../_util/evaluations/endOf");
 ...
 * @summary returns the end of year for current date, shifting it to UTC time.
 *
 ...
 * ```js
 * endOfYear(new Date("2109-09-11")); //=> "2109-12-31T(shifted hours):(shifted minutes):59.999Z";
 * ```
 */
