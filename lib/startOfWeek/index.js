 ...
 * @fileoverview Handles return of distance between date provided and its startDate of week.
 */
...
function startOfWeek(date) {
  ...
  const handler = startOfWeekHandler(typeof date === "number" ? new Date(date) : date);
